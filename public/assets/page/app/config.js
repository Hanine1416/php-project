!function (e) {
  function t(t) {
    for (var n, i, p = t[0], l = t[1], c = t[2], a = 0, s = []; a < p.length; a++) i = p[a], Object.prototype.hasOwnProperty.call(o, i) && o[i] && s.push(o[i][0]), o[i] = 0;
  ...
  var p = this["webpackJsonpinspection-copy"] = this["webpackJsonpinspection-copy"] || [], l = p.push.bind(p);
  p.push = t, p = p.slice();
