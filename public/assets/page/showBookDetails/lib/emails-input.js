...
lib.EmailsInput = (function(utils) {
  ...
  function buildOptions(givenOptions) {
    ...
    var placeholder = $('#emails-input').attr('data-placeholder');
    options.placeholder = options.placeholder || placeholder || 'add more people ...'
  ...
  function addChip(refElement, email) {
    ...
    chip.innerHTML = '<span class="content">'
          + trimmedEmail + '</span><a href="javascript:void(0)" class="remove">×</a>'
