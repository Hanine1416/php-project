...
1. **Preamble:** This Agreement, signed on 19 Jul 2020 (hereinafter: Effective Date) governs the relationship between mobelite.fr (hereinafter: Licensee) and Usablica Limited (612648), a duly registered company in whose principal place of business is 15 Chamber House, Clancy Quay, Islandbridge, Dublin 8 (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Intro.js (hereinafter: The Software) created and owned by Licensor, as detailed herein
